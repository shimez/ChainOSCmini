...
現在の公開版は`0.8.0`です。開発版であることを理解したうえで使用してください。
...
```text
installer/firmware/ChainOSCmini-0.8.0-ChainDualKey-merged.bin
```
...
```text
docs/installer/firmware/ChainOSCmini-0.8.0-ChainDualKey-merged.bin
```
