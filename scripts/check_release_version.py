#!/usr/bin/env python3
"""Validate ChainOSCmini release and Web Installer version references."""
...
def main() -> None:
    ...
    firmware_name = f"ChainOSCmini-{version}-ChainDualKey-merged.bin"
    checksum_name = f"ChainOSCmini-{version}-ChainDualKey-SHA256.txt"
